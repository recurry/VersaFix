...
namespace VfxEngine.FixSessions
{
    ...
    /// for connections using the FIX 4.x model.
    /// </summary>
    public sealed class VfxFix4xServerSession : IVfxFixSession
    {
        /// <summary>
